...
class AjaxHandler {
    ...
    public function registerHooks(): void {
        ...
        add_action('wp_ajax_cloudflare_join_meeting', [$this, 'joinMeeting']);
        ...
        add_action('wp_ajax_nopriv_cloudflare_join_meeting', [$this, 'joinMeeting']);
    }
    ...
    public function createMeeting(): void {
        try {
            ...
            $meeting_data = $this->api_client->createMeeting([
                'title' => $title,
    ...
    public function joinMeeting(): void {
        try {
            ...
            // Add participant to RealtimeKit meeting
            $user_id = get_current_user_id();
            $participant_data = $this->api_client->addParticipant($meeting_id, [
                'name' => $participant_name,
                'preset_name' => 'group_call_participant',
                'custom_participant_id' => $user_id ? (string) $user_id : null,
            ]);
            
            // Update participant count
            $this->database_manager->updateMeeting($meeting_id, [
                'participant_count' => $meeting->getParticipantCount() + 1
            ]);
